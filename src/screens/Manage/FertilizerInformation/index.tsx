...
export default function AgriculturalProcess() {
    ...
    <ImageBackground
      ...
      <View style={{flex: 1, top: '8%'}}>
        ...
        <View style={styles.title}>
          ...
          <Text style={[styles.texttitle, styles.font]}>Fertilizer</Text>
        </View>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={styles.text}>Choose the type of fertilizer</Text>
